...
export default function GeneratedCVsPage() {
    ...
    const filteredCVs = cvs.filter(cv => {
        ...
        const matchesSearch = searchTerm === '' ||
            ...
            (!cv.jobPosting && "general cv".includes(searchTerm.toLowerCase()));
                                            ...
                                            <div className="flex items-start gap-4 mb-4">
                                                ...
                                                <div className="flex-1">
                                                    <h3 className="text-xl font-bold text-gray-900 mb-2">
                                                        {cv.jobPosting ? cv.jobPosting.jobTitle : 'General CV'}
                                                    </h3>
                                                    {cv.jobPosting ? (
                                                        ...
                                                        <div className="flex items-center gap-2 text-gray-500 mb-3">
                                                            ...
                                                            <span className="font-medium italic">General Application</span>
                                                        </div>
                                                    )}
