            ...
            <div className="hidden lg:flex lg:flex-1 flex-col justify-between bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 p-12 text-white relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-8">
                    ...
                    <div className="grid grid-cols-2 gap-6 pt-4">
                        {benefits.map((benefit, index) => (
                            <div key={index} className="flex flex-col items-start gap-3 p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                ...
                <div className="relative z-10 grid grid-cols-3 gap-8 pt-8 border-t border-white/20">
                    ...
                    <div>
                        ...
                        <div className="text-sm text-purple-100">CVs Created</div>
                    </div>
                    <div>
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="lg:hidden flex justify-center mb-8">
                        <Link href="/" className="flex items-center gap-2">
                            <div className="relative w-10 h-10 overflow-hidden rounded-lg bg-white shadow-md border border-gray-100">
                                <Image
                                    src="/logo.png"
                                    alt={APP_NAME}
                                    fill
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button
                            type="button"
                            className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 transition-all duration-200"
                        >
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    type="email"
                                    autoComplete="email"
                                    className={`block w-full pl-12 pr-4 py-3 border rounded-xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-transparent transition-all duration-200 ${errors.email
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`block w-full pl-12 pr-4 py-3 border rounded-xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-transparent transition-all duration-200 ${errors.password
                                        ? 'border-red-300 focus:ring-red-600'
                                        : 'border-gray-300'
                                        }`}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    type="password"
                                    autoComplete="new-password"
                                    className={`block w-full pl-12 pr-4 py-3 border rounded-xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-transparent transition-all duration-200 ${errors.confirmPassword
                                        ? 'border-red-300 focus:ring-red-600'
                                        : 'border-gray-300'
                                        }`}
                        ...
                        <div className="flex items-start">
                            <input
                                ...
                                name="terms"
                                type="checkbox"
                                className="h-4 w-4 mt-0.5 text-indigo-600 focus:ring-indigo-600 border-gray-300 rounded"
                                required
                            />
                        ...
                        <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-4 border border-indigo-100">
                            <div className="flex items-start gap-3">
                                ...
                                <div className="text-sm text-gray-700">
                                    <span className="font-semibold">100% Free Forever.</span> No credit card required. Start creating unlimited CVs immediately.
                                </div>
                            </div>
                        </div>
                    </form>
