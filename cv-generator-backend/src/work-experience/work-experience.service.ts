    ...
    async update(id: string, updateWorkExperienceDto: UpdateWorkExperienceDto) {
        ...
        return this.prisma.workExperience.update({
            ...
            data: {
                ...
                startDate: updateWorkExperienceDto.startDate ? new Date(updateWorkExperienceDto.startDate) : undefined,
                endDate: updateWorkExperienceDto.endDate ? new Date(updateWorkExperienceDto.endDate) : undefined,
            },
        });
    }
