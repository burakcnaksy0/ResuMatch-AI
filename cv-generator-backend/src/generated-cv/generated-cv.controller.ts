...
export class GeneratedCvController {
    ...
    const allTemplates = [
      {
        ...
        description:
          'Traditional single-column layout. Perfect for corporate positions and ATS systems.',
        isPro: false,
      ...
      },
      {
        ...
        category: 'Creative',
        description:
          'Two-column design with sidebar. Ideal for tech and startup positions.',
        isPro: false,
        type: 'local',
        layout: 'two-column',
      ...
      },
      {
        ...
        category: 'Business',
        description:
          'Balanced design with subtle colors. Great for mid-senior level positions.',
        isPro: true,
        layout: 'hybrid',
      ...
      },
      {
        ...
        category: 'Design',
        description:
          'Bold and distinctive design. Perfect for creative and design roles.',
        isPro: true,
        layout: 'creative',
        colorScheme: 'vibrant',
  ...
  async download(
    ...
    const filePath = await this.generatedCvService.getPdfPath(
      id,
      req.user.userId,
    );
