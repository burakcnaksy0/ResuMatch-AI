  ...
  async create(createCertificationDto: CreateCertificationDto) {
    return this.prisma.certification.create({
      data: {
        ...
        expiryDate: createCertificationDto.expiryDate
          ? new Date(createCertificationDto.expiryDate)
          : null,
      },
    });
  }
  ...
  async update(id: string, updateCertificationDto: UpdateCertificationDto) {
    ...
    return this.prisma.certification.update({
      ...
      data: {
        ...
        issueDate: updateCertificationDto.issueDate
          ? new Date(updateCertificationDto.issueDate)
          : undefined,
        expiryDate: updateCertificationDto.expiryDate
          ? new Date(updateCertificationDto.expiryDate)
          : undefined,
      },
    });
  }
